...
public class CategoriaBean {
	...
	public void novo(){
		Categoria pai = null;
		if(this.editada.getIdCategoria() != null){
			CategoriaRN categoriaRN = new CategoriaRN();
			pai = categoriaRN.carregar(this.editada.getIdCategoria());
		}
	...
	public void selecionar(NodeSelectEvent event){
		...
		if(this.editada != null && pai != null && pai.getIdCategoria() != null){
			this.mostraEdicao = true;
		}else{
	...
	public void montaDadosSelect(List<SelectItem> select,
